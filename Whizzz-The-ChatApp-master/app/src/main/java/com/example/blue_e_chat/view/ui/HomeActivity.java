...
import com.example.blue_e_chat.view.adapters.ViewPagerAdapter;
import com.example.blue_e_chat.view.fragments.ChatFragment;
import com.example.blue_e_chat.view.fragments.ProfileFragment;
import com.example.blue_e_chat.view.fragments.UserFragment;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void setupPagerFragment() {
        ...
        viewPagerAdapter.addFragment(new ChatFragment(this), "채팅");
        viewPagerAdapter.addFragment(new UserFragment(this), "상담원");
        viewPagerAdapter.addFragment(new ProfileFragment(this), "프로필");
